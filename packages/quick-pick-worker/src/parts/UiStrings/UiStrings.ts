...
export const GoToSymbolInWorkspace = 'Go to Symbol in Workspace'
...
export const RemoveFromRecentlyOpened = 'Remove from Recently Opened'
...
export const SelectLanguageMode = 'Select Language Mode'
