...
export const commandMap = {
  ...
  'QuickPick.handleInput': WrapCommand.wrapSerialAsyncCommand(HandleInput.handleInputWithContext),
  ...
  'QuickPick.selectCurrentIndex': WrapCommand.wrapSerialCommand(SelectCurrentIndex.selectCurrentIndex),
